...
def run_test_suite(scenario_name):
    ...
    # --- NEW: Visualization and Confirmation Step ---
    print(f"--- 🗺️  Displaying map for scenario: {scenario_name} ---")
    print("    Confirm this is the correct map, then close the plot window to begin the simulation suite.")
    ...
    try:
        ...
        visualizer.draw_city_graph() # This opens the plot and PAUSES the script
    ...
    map_builder_name = scenario['map_builder']
    map_config = scenario['map_config']
    ...
    for run_type in scenario['run_types']:
        for scale in scenario['scales']:
            ...
            full_config['map_builder'] = map_builder_name
            full_config['map_config'] = map_config
